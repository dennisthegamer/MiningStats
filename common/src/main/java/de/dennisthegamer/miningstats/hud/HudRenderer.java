...
public class HudRenderer {
    ...
    private static void renderCompact(GuiGraphics context, Minecraft client) {
        ...
        // Component
        context.drawString(font, text, x + padding, y + padding, 0xFFFFFFFF, true);
    }

    private static void renderFull(GuiGraphics context, Minecraft client) {
        Font font = client.font;
        SessionData session = SessionData.getInstance();
        ModConfig config = ModConfig.getInstance();
