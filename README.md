...
![Minecraft](https://img.shields.io/badge/Minecraft-26.1%E2%80%9326.1.2-green)
...
- [Fabric Loader](https://fabricmc.net/) >= 0.18.6, or [NeoForge](https://neoforged.net/)
...
2. Download the latest `miningstats-fabric-1.5.0+mc26.1-26.1.2.jar` (or `miningstats-neoforge-1.5.0+mc26.1.2.jar`) from [Releases](../../releases)
