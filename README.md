...
![Minecraft](https://img.shields.io/badge/Minecraft-1.21%E2%80%931.21.5-green)
...
2. Download the latest `miningstats-fabric-1.5.0+mc1.21-1.21.5.jar` (or `miningstats-neoforge-1.5.0+mc1.21-1.21.5.jar`) from [Releases](../../releases)
