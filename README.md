...
![Minecraft](https://img.shields.io/badge/Minecraft-1.21.9%E2%80%931.21.11-green)
...
2. Download the latest `miningstats-fabric-1.5.0+mc1.21.9-1.21.11.jar` (or `miningstats-neoforge-1.5.0+mc1.21.9-1.21.11.jar`) from [Releases](../../releases)
